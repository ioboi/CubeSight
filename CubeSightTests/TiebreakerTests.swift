...
struct TiebreakerTests {
  ...
  func testMatchPoints() throws {
    ...
    for i in 0..<8 {
      viewModel.completeMatch(
        roundIndex: i, matchIndex: 0, player1Wins: i < 6 ? 2 : 0, player2Wins: i < 6 ? 0 : 2,
        draws: 0)
    }
    ...
    for i in 0..<8 {
      ...
      if i < 4 {
        if match.player1 == players[0] {
          viewModel.completeMatch(
            roundIndex: i, matchIndex: 0, player1Wins: 0, player2Wins: 2, draws: 0)
        } else {
          viewModel.completeMatch(
            roundIndex: i, matchIndex: 0, player1Wins: 2, player2Wins: 0, draws: 0)
        }
      } else if i < 6 {
        if match.player1 == players[0] {
          viewModel.completeMatch(
        ...
        viewModel.completeMatch(
          roundIndex: i, matchIndex: 0, player1Wins: 1, player2Wins: 1, draws: 1)
      }
    }

    #expect(
      newTournament.performance[players[1]]?.matchPoints == 14,
  ...
  func testGamePoints() throws {
    ...
    #expect(
      tournament.performance[players[0]]?.gamePoints == 19,
  ...
  func testMatchWinPercentage() throws {
    ...
    for i in 0..<8 {
      ...
      if i < 5 {
        ...
        viewModel.completeMatch(
          roundIndex: i, matchIndex: 0, player1Wins: 0, player2Wins: 0, draws: 1)
      }
    }
  ...
  func testGameWinPercentage() throws {
    ...
    for i in 0..<4 {
      if i < 3 {
        viewModel.completeMatch(
          roundIndex: i, matchIndex: 0, player1Wins: 2, player2Wins: 1, draws: 0)
      } else {
        viewModel.completeMatch(
          roundIndex: i, matchIndex: 0, player1Wins: 1, player2Wins: 0, draws: 0)
      }
    }
    ...
    #expect(
      (tournament.performance[players[1]]?.gameWinRate ?? 0).isApproximatelyEqual(to: 0.33),
